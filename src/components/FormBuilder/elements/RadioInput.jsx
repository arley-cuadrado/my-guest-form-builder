    ...
    <Fragment>
      <Paper elevation={1}>
          ...
          <Grid container spacing={1}>
            <Grid item xs={9}>
              <TextField
                ...
                placeholder="Pregunta de opciones"
                sx={{ mb: 2 }}
              />
              {item.options &&
                ...
                item.options.map((opt, key) => (
                  ...
                  <Box sx={{display:'flex'}}>
                    ...
                    />
                    <Tooltip title="Eliminar la opción" aria-label="delete-option">
                      <IconButton
        ...
        <FormGroup row sx={{ alignItems: "center" }}>
          <Tooltip title="Eliminar elemento" aria-label="delete-element">
            <IconButton
          ...
          <Tooltip title="Duplicar elemento" aria-label="duplicate-element">
            <IconButton
