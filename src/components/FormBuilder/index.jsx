...
const FormBuilder = () => {
  ...
  */
  ...
  const crearFormulario = (id, e) => {
    ...
    console.log('Formulario creado!' + JSON.stringify(newArr))
    setData(newArr);
    /*
    console.log('Formulario creado!' + JSON.stringify(newArr))
    setTitle(title);
    ...
    <Fragment>
      <Grid container spacing={1} direction="row" justifyContent="center">
        <Grid item md={6}>
          ...
          />
          {/* Botón crear */}
          <Grid container spacing={1} direction="row" justifyContent="center" className="boton-crear-align">
            <button className="boton-crear" onClick={crearFormulario}>Crear formulario</button>
          </Grid>
        </Grid>
        <Grid item md={1}>
